...
/**
 * This puzzle was pretty smooth- sailing, except for some troubles creating 
 * the 2D- Array (all rows were the same object, modifing one would modify all)
 * and a typo in Line#getCoveredCoords() (Math.min =/= Math.max) 
 */
...
class Line {
     ...
     */
    getCoveredCoords() {
        //TODO: this only horizontal OR vertical lines, where sx == ex or sy == ey
